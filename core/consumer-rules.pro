...
# Keep the variables and methods of the data class and don’t obfuscate it
-keep class com.app.core.data.source.local.entity.* { *; }
-keep class com.app.core.data.source.remote.response.* { *; }
-keep class com.app.core.domain.model.* { *; }
